...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */)                   \
  ...
  INSTPAT("0000001 ????? ????? 001 ????? 01100 11", mulh, R,
          R(rd) = ((int64_t)(int64_t)src1 * (int64_t)(int32_t)src2) >> 32);
  INSTPAT("0000001 ????? ????? 010 ????? 01100 11", mulhsu, R,
          R(rd) = ((int64_t)src1 * (uint64_t)src2) >> 32);
  ...
  // INSTPAT("0000000 00000 00000 000 00000 11100 11", ecall, N); // R(10) is
  // $a0 INSTPAT("0000000 00000 001 00000 00011 11", fence_i, N);
