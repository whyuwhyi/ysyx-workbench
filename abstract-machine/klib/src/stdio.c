  ...
  while (*fmt) {
    if (*fmt != '%') {
      ...
      case 'u': {
        ...
        int len = format_number(ptr, available, (long long)num, 10, 0, width,
                                zero_pad && !left_align);
        if (available > 1) {
          int written = (len < available - 1) ? len : available - 1;
          ptr += written;
      ...
      case 'x': {
        unsigned int num = va_arg(ap, unsigned int);
        int len = format_number(ptr, available, (long long)num, 16, 0, width,
                                zero_pad && !left_align);
        if (available > 1) {
          int written = (len < available - 1) ? len : available - 1;
          ptr += written;
      ...
      case 'X': {
        unsigned int num = va_arg(ap, unsigned int);
        int len = format_number(ptr, available, (long long)num, 16, 1, width,
                                zero_pad && !left_align);
        if (available > 1) {
          int written = (len < available - 1) ? len : available - 1;
          ptr += written;
      ...
      case 'o': {
        unsigned int num = va_arg(ap, unsigned int);
        int len = format_number(ptr, available, (long long)num, 8, 0, width,
                                zero_pad && !left_align);
        if (available > 1) {
          int written = (len < available - 1) ? len : available - 1;
          ptr += written;
