...
object PCSel extends ChiselEnum { val NONE, PC_4, PC_BR, PC_JAL, PC_JALR = Value }
object OpASel extends ChiselEnum { val NONE, RS1, PC = Value }
object OpBSel extends ChiselEnum { val NONE, RS2, IMM = Value }
object AluOp extends ChiselEnum { val NONE, ADD, SUB, AND, OR, XOR, SLL, SRL, SRA, SLT, SLTU, COPY_B = Value }
...
object BranchCond extends ChiselEnum { val NONE, EQ, NE, LT, GE, LTU, GEU = Value }
