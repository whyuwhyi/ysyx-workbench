...
module PC(	// src/main/scala/cpu/ifu/PC.scala:8:7
  ...
  always @(posedge clock) begin	// src/main/scala/cpu/ifu/PC.scala:8:7
    if (reset)	// src/main/scala/cpu/ifu/PC.scala:8:7
      ...
      automatic logic       _take_T_11 = io_branchCond == 3'h1 & io_branchFlags_isZero;	// src/main/scala/cpu/ifu/PC.scala:45:47
      automatic logic [7:0] _GEN =
        {{_take_T_11},
         ...
         {_take_T_11},
         {_take_T_11}};	// src/main/scala/cpu/ifu/PC.scala:45:47, :48:24, :50:24, :52:25
      if (io_pcSel == 3'h4 | io_pcSel == 3'h3 | io_pcSel == 3'h2 & _GEN[io_branchCond])	// src/main/scala/cpu/ifu/PC.scala:23:23, :26:41, :45:47, :56:46, :59:25
        pcReg <=
          ({32{io_pcSel != 3'h4}} | 32'hFFFFFFFE)
          & (io_pcSel == 3'h4 | io_pcSel == 3'h3 ? pcReg : io_rs1) + io_imm;	// src/main/scala/cpu/ifu/PC.scala:21:22, :23:23, :26:41, :35:18, :36:43, :41:31
      else	// src/main/scala/cpu/ifu/PC.scala:56:46, :59:25
  ...
  SimProbePC #(
    .XLEN(32)
  ) simProbePCInst (	// src/main/scala/cpu/ifu/PC.scala:69:32
